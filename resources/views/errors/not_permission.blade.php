...
<div class="errorPageRap">
    <div class="holoContainer">
        <img src="{{asset('errors/img/userNotFoundBanner.png')}}">
        <img src="{{asset('errors/img/userNotFoundBanner_green.png')}}">
        <img src="{{asset('errors/img/userNotFoundBanner_red.png')}}">
    ...
    <h1>
        Xin lỗi bạn không có quyền truy cập vào địa chỉ này
        <br>
        Vui lòng quay lại trang chủ để sử dụng website <a href="/">Trang Chủ</a>
    </h1>
</div>
